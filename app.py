    ...
    if request.method == 'POST':
        ...
        if existing_user is None:
            ...
            users.insert_one({
                ...
                'phone': request.form.get('phone', '')  # Si 'phone' es opcional
            })
...
def admin_login():
    if request.method == 'POST':
        ...
        admin_emails = [ 'admin@gmail.com','secreturismo@gmail.com', 'coordinacionadmi@gmail.com', 'secreparticular@gmail.com']
